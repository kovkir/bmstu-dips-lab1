...
from my_exceptions.http_exceptions import (
...
async def test_patch_success():
    try:
        person = await personService.patch(
            person_id=2,
